							...
							<div class="panel-footer">
								<form method="post">
									<div class="form-group">
										<label>Chọn loại xác nhận</label>
		...
		if ($f1 == "NO") {
			...
			if (mysqli_query($con, $psql)) {
				...
				if (mysqli_query($con, $rpsql)) {
					echo "<script type='text/javascript'> alert('Xác nhận đặt phòng')</script>";
