...
<head>
	<title>KHÁCH SẠN MƯỜNG THANHL</title>
	<!-- for-mobile-apps -->
...
<body>
	...
	<div class="banner-top">
		...
		<div class="contact-bnr-w3-agile">
			<ul>
				<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:info@example.com">muongthanh@gmail.com</a></li>
				<li><i class="fa fa-phone" aria-hidden="true"></i>(0987) 654 321</li>
				<li class="s-bar">
					<div class="search">
		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.php">MƯỜNG <span>THANH</span>
							<p class="logo_w3l_agile_caption">Resort mơ ước</p>
						</a></h1>
				</div>
				...
				<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
					<nav class="menu menu--iris">
						<ul class="nav navbar-nav menu__list">
							...
							<li class="menu__item"><a href="#gallery" class="menu__link scroll">Trưng bày</a></li>
						...
						<div class="w3layouts-banner-top">
							...
							<div class="container">
								<div class="agileits-banner-info">
									<h4>MƯỜNG THANH HOTEL</h4>
									<h3>Chúng tôi biết thứ bạn yêu thích</h3>
									<p>Chào mừng đến với khách sạn chúng tôi</p>
						...
						<div class="w3layouts-banner-top w3layouts-banner-top1">
							<div class="container">
								<div class="agileits-banner-info">
									...
									<p>Đến và tận hưởng với chúng</p>
									<div class="agileits_w3layouts_more menu__item">
										<a href="#" class="menu__link" data-toggle="modal" data-target="#myModal">Xem thêm</a>
									</div>
								</div>
					...
					<li>
						<div class="w3layouts-banner-top w3layouts-banner-top2">
							<div class="container">
								<div class="agileits-banner-info">
									<h4>MƯỜNG THANH HOTEL</h4>
									<h3>Một kỳ nghỉ sang trọng</h3>
									<p>Đặt phòng ngay từ hôm nay</p>
									<div class="agileits_w3layouts_more menu__item">
										<a href="#" class="menu__link" data-toggle="modal" data-target="#myModal">Xem thêm</a>
									</div>
								</div>
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4>MƯỜNG <span>THANH</span></h4>
					<img src="images/1.jpg" alt=" " class="img-responsive">
					<h5>Chúng tôi biết bạn cần gì</h5>
				...
				<ul class="cbp-ig-grid">
					<li>
						<div class="w3_grid_effect">
							...
							<span class="cbp-ig-category">MƯỜNG THANH HOTEL</span>
						</div>
					</li>
					<li>
						<div class="w3_grid_effect">
							<span class="cbp-ig-icon w3_cube"></span>
							<h4 class="cbp-ig-title">PHÒNG VIEW BIỂN</h4>
							<span class="cbp-ig-category">MƯỜNG THANH HOTEL</span>
						</div>
					</li>
					<li>
	...
	<div class="about-wthree" id="about">
		<div class="container">
			<div class="ab-w3l-spa">
				<h3 class="title-w3-agileits title-black-wthree">Về khách sạn MƯỜNG THANH HOTEL</h3>
	...
	<div class="team" id="team">
		<div class="container">
			<h3 class="title-w3-agileits title-black-wthree">Gặp gỡ đội ngũ của chúng tôi</h3>
	...
	<section class="contact-w3ls" id="contact">
		<div class="container">
			...
			<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
				...
				<p class="contact-agile1"><strong>Số điện thoại :</strong>(0987) 654 321</p>
				<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:name@example.com">muongthanh@gmail.com</a></p>
				<p class="contact-agile1"><strong>Địa chỉ :</strong> Mường Thanh, Thanh Hóa, Việt Nam</p>
	...
	<!-- /contact -->
	<div class="copy">
		<p>© 2023 MUONGTHANH . All Rights Reserved | Design by <a href="index.php">MUONGTHANHHOTL</a> </p>
	</div>
	<!--/footer -->
	<!-- js -->
